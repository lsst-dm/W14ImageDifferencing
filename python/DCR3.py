...
if __name__ == "__main__":
    ...
    for bpname in ("g", "r", "i"):
        ...
        for sidx, sed in enumerate(seds):
            ...
            sp1.contour(drA, levels=(-3,), colors=("r",), linewidths=(3,), linestyles=("solid",))
            hmap2 = sp2.pcolor(drM, cmap=plt.cm.Greys, shading="faceted", vmin=-4, vmax=-1)
            sp2.set_xticklabels(dthetas[::4], minor=False, weight="bold", fontsize=12)
            ...
            sp2.contour(drA, levels=(-3,), colors=("r",), linewidths=(3,), linestyles=("solid",))
